...
xilinx.com:user:ctrl_regs_fsm:1.0\
xilinx.com:user:accelerator_wrapper:1.0\
...
proc create_hier_cell_microblaze_riscv_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_ilmb [get_bd_intf_pins ILMB] [get_bd_intf_pins ilmb_v10/LMB_M]
  connect_bd_intf_net -intf_net microblaze_riscv_0_ilmb_bus [get_bd_intf_pins ilmb_bram_if_cntlr/SLMB] [get_bd_intf_pins ilmb_v10/LMB_Sl_0]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ctrl_regs_fsm_0, and set properties
  set ctrl_regs_fsm_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ctrl_regs_fsm:1.0 ctrl_regs_fsm_0 ]

  # Create instance: accelerator_wrapper_0, and set properties
  set accelerator_wrapper_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:accelerator_wrapper:1.0 accelerator_wrapper_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins ctrl_regs_fsm_0/s_axi]
  ...
  # Create port connections
  connect_bd_net -net accelerator_wrapper_0_ack  [get_bd_pins accelerator_wrapper_0/ack] \
  [get_bd_pins ctrl_regs_fsm_0/ack]
  connect_bd_net -net accelerator_wrapper_0_addrb  [get_bd_pins accelerator_wrapper_0/addrb] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net accelerator_wrapper_0_busy  [get_bd_pins accelerator_wrapper_0/busy] \
  [get_bd_pins ctrl_regs_fsm_0/busy]
  connect_bd_net -net accelerator_wrapper_0_clkb  [get_bd_pins accelerator_wrapper_0/clkb] \
  [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net accelerator_wrapper_0_dinb  [get_bd_pins accelerator_wrapper_0/dinb] \
  [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net accelerator_wrapper_0_done  [get_bd_pins accelerator_wrapper_0/done] \
  [get_bd_pins ctrl_regs_fsm_0/done]
  connect_bd_net -net accelerator_wrapper_0_enb  [get_bd_pins accelerator_wrapper_0/enb] \
  [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net accelerator_wrapper_0_rstb  [get_bd_pins accelerator_wrapper_0/rstb] \
  [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net accelerator_wrapper_0_web  [get_bd_pins accelerator_wrapper_0/web] \
  [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net blk_mem_gen_0_doutb  [get_bd_pins blk_mem_gen_0/doutb] \
  [get_bd_pins accelerator_wrapper_0/doutb]
  ...
  connect_bd_net -net ctrl_regs_fsm_0_dst_addr  [get_bd_pins ctrl_regs_fsm_0/dst_addr] \
  [get_bd_pins accelerator_wrapper_0/dst_addr]
  connect_bd_net -net ctrl_regs_fsm_0_go  [get_bd_pins ctrl_regs_fsm_0/go] \
  [get_bd_pins accelerator_wrapper_0/go]
  connect_bd_net -net ctrl_regs_fsm_0_src_a_addr  [get_bd_pins ctrl_regs_fsm_0/src_a_addr] \
  [get_bd_pins accelerator_wrapper_0/src_a_addr]
  connect_bd_net -net ctrl_regs_fsm_0_src_b_addr  [get_bd_pins ctrl_regs_fsm_0/src_b_addr] \
  [get_bd_pins accelerator_wrapper_0/src_b_addr]
  ...
  [get_bd_pins ctrl_regs_fsm_0/s_axi_aclk] \
  [get_bd_pins accelerator_wrapper_0/clk]
  ...
  [get_bd_pins ctrl_regs_fsm_0/s_axi_aresetn] \
  [get_bd_pins accelerator_wrapper_0/resetn]

  # Create address segments
  assign_bd_address -offset 0xC0000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs ctrl_regs_fsm_0/s_axi/reg0] -force
