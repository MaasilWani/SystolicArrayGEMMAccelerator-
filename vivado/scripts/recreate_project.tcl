...
#
# recreate_project.tcl: Tcl script for re-creating project 'systolic_array_T3'
#
# Generated by Vivado on Sun May 10 17:00:14 -0400 2026
...
#
#    "C:/Users/maasi/systolic_array_T3/systolic_array_T3.srcs/sources_1/new/ctrl_regs.sv"
#    "C:/Users/maasi/systolic_array_T3/systolic_array_T3.srcs/sources_1/new/pe_stub.sv"
#    "C:/Users/maasi/systolic_array_T3/systolic_array_T3.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/maasi/Downloads/Arty-A7-100-Master.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new/ctrl_regs.sv"]"\
 "[file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new/pe_stub.sv"]"\
 "[file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../../Downloads/Arty-A7-100-Master.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/new4"]"]"\
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/NewPackageIP"]"]"\
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/new2"]"]"\
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/new1"]"]"\
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/new"]"]"\
 "[file normalize "$origin_dir/../../../../AppData/systolic_array_T3/systolic_array_T3.srcs/sources_1/new3"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "systolic_array_T3"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../systolic_array_T3"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new4"] [file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/NewPackageIP"] [file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new2"] [file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new1"] [file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new"] [file normalize "$origin_dir/../../../../systolic_array_T3/systolic_array_T3.srcs/sources_1/new3"]" $obj
...
set file "new/ctrl_regs.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "new/pe_stub.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "[file normalize "$origin_dir/../../../../Downloads/Arty-A7-100-Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../../Downloads/Arty-A7-100-Master.xdc"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../../systolic_array_T3/systolic_array_T3.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
